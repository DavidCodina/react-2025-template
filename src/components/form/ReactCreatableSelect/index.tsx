...
import { IReactSelectCreatable, SelectOption } from './types'
...
//   onCreateOption
//
// ReactSelectCreatable is almost identical to ReactSelect, except it implements
// CreatableSelect instead of Select. It would be super easy integrate this into
// the current ReactSelect component, adding an isCreatable prop. However, the
// rationale for NOT doing that is it would essentially double the KB size of the component.
//
///////////////////////////////////////////////////////////////////////////

export const ReactCreatableSelect = forwardRef(
  (
    {
      className = '',
      error,
...
ReactCreatableSelect.displayName = 'ReactSelectCreatable'
