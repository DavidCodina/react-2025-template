    ...
    <header className='relative mx-auto max-w-[600px] rounded-lg border border-sky-500 bg-white p-2 shadow [interpolate-size:allow-keywords]'>
      ...
      >
        ...
        <div className='px-2 pb-2'>
          <ul className='min-w-[150px] overflow-hidden rounded-lg border border-sky-700 bg-sky-400 text-center font-bold text-white shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]'>
