    ...
    <>
      ...
      >
        {items.map((item) => (
          <Reorder.Item
            as='li' // Default
            className={`relative block cursor-pointer border border-neutral-400 bg-white px-2 py-2 text-sm font-semibold shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] first:rounded-t-[inherit] last:rounded-b-[inherit] [&:not(:first-child)]:border-t-0`}
            key={item}
            value={item}
          >
            {item}. Bla, bla, bla...
